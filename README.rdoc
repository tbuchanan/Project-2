...
Popspot http://popups-app.herokuapp.com/

Authors: Tyler Buchanan and Ami Mathur

POPSPOT

Popspot, as the name suggests is an app that helps users in finding pop-ups nearest to them.
...
Popspot hopes to consolidate all the information users need about existing pop-ups in one place so that these businesses can become more accessible to a larger section of the community.

TOP FEATURES OF POPSPOT
...
P.S If you know of a Popup, add it to Popspot and help others like you from missing out on a cool Popup!
